...
namespace WFP1A
{
    public partial class Form1 : Form
    {
        ...
        {
            string archivo = @"C:\Users\alumno\Documents\carpeta1\alunos.txt";
        ...
        {
            oAlumnos = DatosFormulario();
            DialogResult ev = MessageBox.Show("Estas seguro de eliminar al alumno", "Adertencia", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
            if (ev == DialogResult.Yes)
            {
                ...
                if (respuesta > 0)
                {
                    MessageBox.Show("El alumno a sido eliminado");
                    LimpiarDatos();
                    DesplegarGrid();
                }
                else
