    ...
    public class ClsImportExport
    {
        ...
        public string importar(string archivo)
        {
            ...
            try
            {
                ...
                return $"Ejecutado:{cone.EjecutarSQLDirecto(texto)}";
            }
            catch (Exception ex)
            {
        ...
        public string exportar(string instruccion, string archivoDestino)
        {
            ...
            {
                textoSalida += $"{dr["idAlumnos"]};{dr["carnet"]};{dr["nombre"]};{dr["correo"]};{dr["clase"]};{dr["seccion"]};{dr["parcial1"]};{dr["parcial2"]};{dr["parcial3"]}\n";
            }
